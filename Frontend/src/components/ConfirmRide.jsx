...
const ConfirmRide = (props) => {
    return (
        <div>
            ...
            <h3 className='text-3xl text-center text-white font-bold mb-5'>Confirm your Ride</h3>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                }} className='w-full mt-5 bg-green-500 text-white text-xl font-bold p-2 rounded-lg'>Confirm</button>
            </div>
        </div>
    )
}
